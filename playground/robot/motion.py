...
def ask_questions(session, tts_service):
    ...
    attitude_to_logic = raw_input("Enter your answer (1,2,3,4,5): ")

    patience = sentences(4)
    move_talk(robot=session, text=patience, char="talk", service=tts_service)
    how_much_patience = raw_input("Enter your answer (little, enough, a lot): ")

    art = sentences(5)
    move_talk(robot=session, text=art, char = "", service=tts_service)
    like_art = raw_input("Enter you anser (little, enough, a lot): ")
